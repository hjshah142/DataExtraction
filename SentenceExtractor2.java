...
//			responseRader();
			...
			for (int i = 0; i < 3; i++) 
			{
				String sparql_result = null;
				responseRader(i, sparql_result);
				System.out.println("Retun Value....");
...
//					port_vs_extractorMap.put("sorookin", 2227);
	...
	public static String responseRader(int i, String sparql_query_result )
	{ 
//		System.out.println(sparql_result);
